...
<head>
    ...
    <title>Panel de Estudiante - INSTITUTO SINERGIA</title>
...
<div class="d-flex" id="wrapper">
    ...
    <div class="bg-dark border-right" id="sidebar-wrapper">
        ...
        <div class="list-group list-group-flush">
            ...
            <a href="mis_calificaciones.php" class="list-group-item list-group-item-action bg-dark text-white">
                <i class="fas fa-graduation-cap me-2"></i>Mis Calificaciones
            </a>
            <a href="mi_horario.php" class="list-group-item list-group-item-action bg-dark text-white">
                <i class="fas fa-calendar-alt me-2"></i>Mi Horario
            </a>
            <a href="mi_asistencia.php" class="list-group-item list-group-item-action bg-dark text-white">
                <i class="fas fa-clipboard-check me-2"></i>Mi Asistencia
            </a>
            <a href="mis_pagos.php" class="list-group-item list-group-item-action bg-dark text-white">
