...
<h1 class="mb-4">Gestionar Tareas</h1>
<p>Selecciona un curso para crear, editar o eliminar tareas para tus estudiantes.</p>
                    ...
                    <?php if (!empty($cursos_asignados)): ?>
                        <?php foreach($cursos_asignados as $curso): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="gestionar_tareas_curso.php?id_asignacion=<?php echo $curso['id_asignacion']; ?>" class="btn btn-sm btn-info" title="Gestionar Tareas">
